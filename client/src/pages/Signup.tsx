      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-lg p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Create an account to explore with Aroha</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-gray-900/50 text-gray-500">Available signup methods</span>
              </div>
            </div>

            {/* Signup Methods Display */}
          ...
          <div className="mt-8 pt-6 border-t border-gray-700/50 text-center">
            <p className="text-sm text-gray-400">
              ...
              <a href="/login" className="text-cyan-400 hover:text-cyan-300 font-medium" data-testid="link-login">
                Sign in
              </a>
            </p>
          </div>
